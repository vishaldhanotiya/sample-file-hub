...
export const getMetaData = (fileType) => {
  switch (fileType) {
    ...
    case "jpg":
      ...
      <p>
        One of the biggest advantages of <strong>JPEG files</strong> is their <strong>small file size</strong>, which ensures faster <strong>loading times</strong> on websites—a crucial factor for <strong>SEO</strong> and <strong>user experience</strong>. Unlike <strong>lossless formats</strong> like PNG or GIF, JPEGs use intelligent <strong>compression</strong> to discard only the colors the human eye can’t easily detect, keeping images lightweight without noticeable quality loss. This makes them ideal for <strong>digital cameras</strong>, <strong>smartphones</strong>, and <strong>online platforms</strong> where quick uploads and smooth viewing matter.
      </p>
...
<ul>
  <li>Perfect for <strong>logos</strong>, <strong>illustrations</strong>, and <strong>text-heavy images</strong></li>
  <li>Supports <strong>transparency</strong> (including alpha channel)</li>
  <li>Retains <strong>image quality</strong> after multiple edits</li>
  <li>Compatible across <strong>browsers</strong> and <strong>design software</strong></li>
</ul>
...
<p>One of the key advantages of <strong>WEB files</strong> includes:
  <ul>
    <li><strong>Editability and flexibility</strong> for updates and optimizations</li>
    <li><strong>Improved SEO</strong> through crawlable and structured content</li>
...
<p><strong>SVG files</strong> offer multiple benefits:
  <ul>
    <li><strong>Resolution independence</strong> for sharp visuals on any screen</li>
    <li><strong>Lightweight file size</strong> for faster web performance</li>
    <li><strong>Editable XML structure</strong> for custom designs</li>
    <li><strong>Broad compatibility</strong> with browsers and tools</li>
  </ul>
...
<p>The main advantages of <strong>GIF files</strong> include:
  <ul>
    <li><strong>Animation support</strong> for short looping clips</li>
    <li><strong>Wide compatibility</strong> across browsers and devices</li>
    <li><strong>Small file size</strong> for web usage</li>
    <li><strong>Ideal for memes and tutorials</strong></li>
  </ul>
...
<p>The primary advantages of <strong>BMP files</strong> include:
  <ul>
    <li><strong>Lossless image quality</strong> preserving all pixel data</li>
    <li><strong>Wide compatibility</strong> with Windows-based software</li>
    <li><strong>Simple structure</strong> easy to edit and manipulate</li>
    <li><strong>Ideal for professional printing</strong> and icon creation</li>
  </ul>
...
<p>The key benefits of <strong>MP4 files</strong> include:
  <ul>
    <li><strong>High-quality video and audio</strong> support</li>
    <li><strong>Lightweight compression</strong> for smooth streaming</li>
    <li><strong>Subtitle integration</strong> for multilingual content</li>
    <li><strong>Universal device compatibility</strong></li>
  </ul>
...
<p>The advantages of <strong>MKV files</strong> include:
  <ul>
    <li><strong>Support for multiple audio and subtitle tracks</strong></li>
    <li><strong>High-definition video support</strong></li>
    <li><strong>Open-source flexibility</strong> for developers</li>
    <li><strong>Ideal for archiving and editing</strong></li>
  </ul>
...
<p>The main advantages of <strong>AVI files</strong> include:
<ul>
<li><strong>High-quality video</strong></li><li><strong>Supports multiple codecs</strong></li><li><strong>Easy to edit</strong></li><li><strong>Wide compatibility with media players</strong></li>
</ul>
...
<p>The main advantages of <strong>FLV files</strong> include:
<ul>
<li><strong>Lightweight and fast streaming</strong></li><li><strong>Supports embedded audio/video</strong></li><li><strong>Ideal for tutorials and courses</strong></li><li><strong>Compatible with legacy Flash players</strong></li>
</ul>
...
<p>The main advantages of <strong>MOV files</strong> include:
<ul>
<li><strong>High-quality video and audio support</strong></li><li><strong>Advanced editing compatibility</strong></li><li><strong>Supports multiple tracks</strong></li><li><strong>Cross-platform playback with QuickTime player</strong></li>
</ul>
...
<p>The main advantages of <strong>WEBM files</strong> include:
<ul>
<li><strong>Efficient streaming</strong></li><li><strong>Small file size</strong></li><li><strong>High-definition support</strong></li><li><strong>Broad web compatibility</strong></li>
</ul>
...
<p>The main advantages of <strong>MP3 files</strong> include:
<ul>
<li><strong>Small file size</strong></li><li><strong>High audio quality</strong></li><li><strong>Universal support</strong></li><li><strong>Ideal for music, podcasts, and audiobooks</strong></li>
</ul>
...
<p>The main advantages of <strong>AAC files</strong> include:
<ul>
<li><strong>Superior audio quality</strong></li><li><strong>Efficient compression</strong></li><li><strong>Wide compatibility</strong></li><li><strong>Ideal for music streaming and podcasts</strong></li>
</ul>
...
<p>The main advantages of <strong>WAV files</strong> include:
<ul>
<li><strong>Lossless audio quality</strong></li><li><strong>Easy editing</strong></li><li><strong>Broad compatibility</strong></li><li><strong>Ideal for professional music production</strong></li>
</ul>
...
<p>The main advantages of <strong>OGG files</strong> include:
<ul>
<li><strong>Open-source flexibility</strong></li><li><strong>Efficient compression</strong></li><li><strong>Quality audio playback</strong></li><li><strong>Ideal for streaming and multimedia</strong></li>
</ul>
...
<p>The main advantages of <strong>ODT files</strong> include:
<ul>
<li><strong>Open-source compatibility</strong></li><li><strong>Easy editing</strong></li><li><strong>Preserves formatting</strong></li><li><strong>Ideal for essays, reports, and official documents</strong></li>
</ul>
...
<p>The main advantages of <strong>RTF files</strong> include:
<ul>
<li><strong>Universal compatibility</strong></li><li><strong>Lightweight structure</strong></li><li><strong>Easy formatting</strong></li><li><strong>Ideal for letters, notes, and simple documents</strong></li>
</ul>
...
<p>The main advantages of <strong>PPTX files</strong> include:
<ul>
<li><strong>Supports animations and multimedia</strong></li><li><strong>Editable slides</strong></li><li><strong>Professional presentation use</strong></li><li><strong>Compatible with modern PowerPoint software</strong></li>
</ul>
...
<p>The main advantages of <strong>DOCX files</strong> include:
<ul>
<li><strong>Editability</strong></li><li><strong>Cross-platform compatibility</strong></li><li><strong>Supports multimedia</strong></li><li><strong>Ideal for reports, essays, and letters</strong></li>
</ul>
...
<p>The main advantages of <strong>TXT files</strong> include:
<ul>
<li><strong>Lightweight</strong></li><li><strong>Universal compatibility</strong></li><li><strong>Simple and editable</strong></li><li><strong>Ideal for notes, logs, and coding</strong></li>
</ul>
...
<p>The main advantages of <strong>ZIP files</strong> include:
<ul>
<li><strong>File compression</strong></li><li><strong>Multiple files in one archive</strong></li><li><strong>Supports encryption</strong></li><li><strong>Ideal for sharing and backups</strong></li>
</ul>
