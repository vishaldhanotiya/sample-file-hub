...
const faqs = [

  {
    ...
    answer: "No account or signup is required. Simply browse the categories and download the files you need instantly.",
  },
  {
    question: "Can I request new file types or specific sample files?",
    answer: "Absolutely! Use our Contact page to suggest new files or formats, and we’ll try to add them.",
  },
  {
  ...
  },
  {
    ...
    answer: "Yes. All files are scanned and safe for download. We ensure they are free from viruses or malware.",
  },
  {
    question: "How often are new files added?",
    answer: "We regularly update our library with new images, videos, audios, and documents to keep our collection fresh and useful.",
  },
];
const FAQAccordion = () => {
