...
export default function PlaceholderImageGenerator() {
  ...
  const [iconAlignment, setIconAlignment] = useState("custom"); // custom | top-left | top-right | bottom-left | bottom-right | center | top-center | bottom-center | left-center | right-center
  ...
  useEffect(() => {
    if (iconAlignment === "custom") return;
    ...
    const calculateIconPosition = () => {
      ...
      setIconX(Math.round(x));
      setIconY(Math.round(y));
    };

    calculateIconPosition();
  }, [iconAlignment, width, height, iconSize]);
  ...
  const validate = (w, h) => {
    ...
    if (W > MAX_DIM || H > MAX_DIM)
      return `Max dimension is ${MAX_DIM} to avoid memory issues.`;
    return null;
  };
  ...
  const drawText = (ctx, w, h) => {
    ...
    const display =
      includeSizeInText && targetSizeMB ? `${base} — ${targetSizeMB} MB` : base;
    ...
    if (alignment === "center") {
      ...
      ctx.fillText(
        display,
        w / 2,
        alignment === "top" ? 12 + borderWidth : h - 12 - borderWidth
      );
    }
  };
  ...
  const renderCanvasToBlob = async (
    options = { mime: "image/png", quality: 0.9, targetBytes: null }
  ) => {
    setError(null);
      ...
      if (finalBlob.size < options.targetBytes) {
        ...
        if (mime !== "image/png") {
          ...
          for (let i = 0; i < 6; i++) {
            ...
            const b2 = await new Promise((res) =>
              canvas.toBlob((b) => res(b), mime, mid)
            );
            if (!b2) break;
  ...
  const handleDownload = async () => {
    try {
      ...
      a.href = url;
      a.download = `placeholder_${width}x${height}.${
  ...
  const randomize = () => {
    ...
    setBgType(
      ["solid", "linear-gradient", "radial-gradient", "pattern"][
        ...
        <div className="col-lg-4 mb-3">
          ...
          <div className="card mb-2">
            <div
              ...
              onClick={() =>
                setOpenAccordion(
                  openAccordion === "dimensions" ? null : "dimensions"
                )
              }
            >
          ...
          <div className="card mb-2">
            <div
              ...
              onClick={() =>
                setOpenAccordion(
                  openAccordion === "background" ? null : "background"
                )
              }
            >
          ...
          <div className="card mb-2">
            <div
              ...
              style={{ cursor: "pointer" }}
              onClick={() =>
                setOpenAccordion(openAccordion === "text" ? null : "text")
              }
            >
              ...
              <div className="card-body">
                ...
                <div className="form-check form-switch mb-2">
                  <input
                    ...
                    type="checkbox"
                    id="includeSize"
                    checked={includeSizeInText}
                    onChange={(e) => setIncludeSizeInText(e.target.checked)}
                  />
                  <label className="form-check-label" htmlFor="includeSize">
                    Include file size in text
                  </label>
                </div>
          ...
          <div className="card mb-2">
            <div
              ...
              style={{ cursor: "pointer" }}
              onClick={() =>
                setOpenAccordion(openAccordion === "effects" ? null : "effects")
              }
            >
            ...
            {openAccordion === "effects" && (
              <div className="card-body">
                ...
                <div className="form-check form-switch mb-2">
                  ...
                  />
                  <label className="form-check-label" htmlFor="shadowToggle">
                    Shadow
                  </label>
                </div>
                <div className="mb-2">
                  ...
                  <div className="form-text">
                    CSS shadow string used for preview box (e.g. 0 6px 18px
                    rgba(0,0,0,0.12))
                  </div>
                </div>
              </div>
          ...
          <div className="card mb-2">
            <div
              ...
              style={{ cursor: "pointer" }}
              onClick={() =>
                setOpenAccordion(openAccordion === "file" ? null : "file")
              }
            >
            ...
            {openAccordion === "file" && (
              <div className="card-body">
                ...
                <div className="mb-2">
                  ...
                  />
                  <div className="form-text">
                    If set, system will try to inflate or compress to match
                    target size (best effort).
                  </div>
                </div>
              </div>
            )}
          ...
          {/* <div className="card mb-2">
            <div
              ...
              style={{ cursor: "pointer" }}
              onClick={() =>
                setOpenAccordion(openAccordion === "extras" ? null : "extras")
              }
            >
            ...
            {openAccordion === "extras" && (
              <div className="card-body">
                ...
                <div className="mb-2">
                  <label className="form-label">Icon Alignment</label>
                  <select
                    className="form-select"
                    value={iconAlignment}
                    onChange={(e) => setIconAlignment(e.target.value)}
                  >
                ...
                <div className="row mb-2">
                  <div className="col-4">
                    ...
                    <input
                      ...
                      value={iconX}
                      onChange={(e) => {
                        setIconX(Number(e.target.value));
                        setIconAlignment("custom");
                      }}
                    />
                  </div>
                  <div className="col-4">
                    ...
                    <input
                      ...
                      value={iconY}
                      onChange={(e) => {
                        setIconY(Number(e.target.value));
                        setIconAlignment("custom");
                      }}
                    />
                  </div>
          ...
          {/* <div className="card mb-2">
            <div
              ...
              style={{ cursor: "pointer" }}
              onClick={() =>
                setOpenAccordion(openAccordion === "dev" ? null : "dev")
              }
            >
                ...
                <div className="mb-2">
                  ...
                  <div className="d-flex gap-2">
                    <button
                      ...
                      onClick={async () => {
                        await handleCopyBase64();
                      }}
                    >
                      Copy Base64
                    </button>
                    <div className="form-text align-self-center">
                      (copies data URL to clipboard)
                    </div>
                  </div>
                </div>
              ...
              <div className="container-fluid">
                <div className="d-flex gap-2 align-items-center">
                  ...
                  {/* <div className="form-check form-switch ms-3">
                        ...
                        />
                        <label className="form-check-label small" htmlFor="darkSwitch">
                Dark
              </label>
                      </div> */}
                </div>
                    ...
                    {previewUrl ? (
                      <img
                        ...
                        style={{
                          ...
                          boxShadow: shadowEnabled ? shadowCss : "none",
                          border: borderWidth
