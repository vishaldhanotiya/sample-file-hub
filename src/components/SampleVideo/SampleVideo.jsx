...
const SampleVideo = () => {
  ...
  useEffect(() => {
    if (videoTabData.length > 0 && videoTabData[0].key) {
      setActiveTab(fileType || videoTabData[0].key);
      fetchFiles(fileType || videoTabData[0].key);
    }
  }, [videoTabData, fileType]);
