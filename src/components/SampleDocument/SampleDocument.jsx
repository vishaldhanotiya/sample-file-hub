...
const SampleDocument = () => {
  ...
  const [activeTab, setActiveTab] = useState(fileType || documentTabData[0]?.key || "");
  ...
  useEffect(() => {
    if (documentTabData.length > 0 && documentTabData[0].key) {
      setActiveTab(fileType || documentTabData[0].key);
      fetchFiles(fileType || documentTabData[0].key);
    }
  }, [documentTabData, fileType]);
